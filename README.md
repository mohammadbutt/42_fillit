...
To get the x coordinate, we take the position of a tetromino and do modulo 5. To get the y coordinate, we take the position of a tetromino and divide that by 5.
