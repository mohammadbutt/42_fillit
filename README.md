...
- [ ] 9. Create an empty grid function, so when we enter 4 into that function it creates a grid of 4 by 4. Linear grid works. Create a grid of double pointer/ double array, so we can enter x and y coordinates.
```
A table of 5 by 5. 
.....
.....
